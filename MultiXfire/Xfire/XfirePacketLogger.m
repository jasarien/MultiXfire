...
- (NSString *)nameForPacketID:(NSUInteger)pktID;
- (NSString *)nameForTypeID:(NSUInteger)typeID;
@end
...
- (void)logMessageForValue:(XfirePacketAttributeValue *)val indent:(NSString *)indent string:(NSMutableString *)desc
{
	...
	switch( tid )
	{
		...
		case 2:
			{
				...
				NSUInteger nbrVal = [nbr unsignedIntValue];
		...
		case 7:
			{
				NSNumber *nbr = [val value];
				NSUInteger nbrVal = [nbr unsignedLongLongValue];
		...
		case 8:
			{
				NSNumber *nbr = [val value];
				NSUInteger nbrVal = [nbr unsignedCharValue];
