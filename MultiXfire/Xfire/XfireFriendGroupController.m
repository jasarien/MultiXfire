...
- (void)addClanWithID:(NSUInteger)clanID name:(NSString *)name shortName:(NSString *)shortName
{
...
- (void)addCustomGroupNamed:(NSString *)aName withID:(NSUInteger)groupID
{
...
- (void)addFriend:(XfireFriend *)fr toGroupWithID:(NSUInteger)groupID
{
...
- (void)addPendingMemberID:(NSUInteger)userID groupID:(NSUInteger)gid
{
...
- (XfireFriendGroup *)groupForID:(NSUInteger)groupID
{
	NSUInteger i, cnt;
	XfireFriendGroup *grp;
