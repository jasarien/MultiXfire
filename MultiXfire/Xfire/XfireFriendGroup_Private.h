...
- (id)initWithClanID:(NSUInteger)groupID name:(NSString *)name shortName:(NSString *)shortName session:(XfireSession *)session;

// Pending members - apply only to Custom groups
- (void)addPendingMemberID:(NSUInteger)userID;
- (int)indexOfPendingMember:(NSUInteger)userID;
