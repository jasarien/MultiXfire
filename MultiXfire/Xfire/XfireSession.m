...
- (XfireFriend *)friendForUserID:(NSUInteger)anID
{
	XfireFriend *f;
	NSUInteger i, len;
...
- (NSUInteger)compiledClientVersion
{
	return 101;
}

- (void)setLatestClientVersion:(NSUInteger)ver
{
	_latestClientVersion = ver;
}

- (NSUInteger)latestClientVersion
{
	return _latestClientVersion;
}

- (void)setPosingClientVersion:(NSUInteger)posingVersion
{
