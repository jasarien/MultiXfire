...
#define kXfirePacketAttributeUInt32Type          (0x02) /* NSNumber(NSUInteger) */
...
#define kXfirePacketAttributeUInt64Type          (0x07) /* NSNumber(NSUInteger long) */
...
+ (id)attributeValueWithInt:(NSUInteger)val;
+ (id)attributeValueWithInt64:(NSUInteger)val;
+ (id)attributeValueWithByte:(unsigned char)val;
+ (id)attributeValueWithNumber:(NSNumber *)nbr; // should be NSUInteger anyway
